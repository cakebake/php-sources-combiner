...
class CombinePhpRequireOnceTest extends cakebake\combiner\TestCase
{
    ...
    */
    public function test1LevelRequireOnce()
    {
        ...
        $this->assertTrue(isset($combinedFiles['vfs://test1LevelRequireOnce/index.php']));
        $this->assertTrue(isset($combinedFiles['vfs://test1LevelRequireOnce/filename1-level-1.php']));
        $this->assertTrue(isset($combinedFiles['vfs://test1LevelRequireOnce/filename2-level-1.php']));
    }
